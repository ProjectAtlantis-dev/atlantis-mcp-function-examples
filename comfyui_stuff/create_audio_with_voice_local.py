...
@visible
async def create_audio_with_voice(prompt: str = "Hello! This is a test of the voice cloning system."):
    """
    ...
    async def process_uploaded_audio(filename, filetype, base64Content, data=None):
        try:
            ...
            # Upload audio to ComfyUI server first
            with open(temp_path, 'rb') as f:
                files = {'image': (temp_filename, f, 'audio/mpeg')}
