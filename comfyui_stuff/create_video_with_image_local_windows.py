...
@visible
async def create_video_with_image(prompt: str = "she sways her hips from side-to-side as if dancing to unheard music and winks as the camera zooms in for a close-up of her face", **kwargs):
    """
